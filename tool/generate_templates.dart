...
void _generateScheduleTemplate(String path) {
  ...
  // Using English headers as internal keys, but can be Arabic if parser expects it.
  // The existing parser likely expects English keys or I should update it. 
  // Let's check the existing parser logic later. For now, standard headers.
  List<String> headers = ['Day', 'Period', 'Class', 'Subject', 'Teacher'];
