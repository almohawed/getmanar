...
class _RingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(Rect.fromCircle(center: center, radius: radius),
        -math.pi / 2, sweepAngle, false, fgPaint);
  }
...
class SmartAttendanceDashboard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SmartAttendanceDashboard> createState() =>
      _SmartAttendanceDashboardState();
}

class _SmartAttendanceDashboardState
    extends ConsumerState<SmartAttendanceDashboard>
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                  child: Padding(
                      ...
                      child: _buildAttendanceRateCard(
                          absences.length, tardiness.length, schoolId))),
              SliverToBoxAdapter(
                  child: Padding(
              ...
              SliverToBoxAdapter(
                  child: Padding(
                      padding: EdgeInsets.fromLTRB(16.w, 14.h, 16.w, 0),
                      child: _buildSmartInsightsCard(absences, tardiness))),
              SliverToBoxAdapter(
                  child: Padding(
                      padding: EdgeInsets.fromLTRB(16.w, 20.h, 16.w, 8.h),
                      child: _buildSectionHeader(
                          'الطلاب الغائبون والمتأخرون',
                          Icons.people_alt_rounded,
                          '${absences.length + tardiness.length} طالب'))),
  ...
  Widget _buildHeroHeader(
      ...
      List<DailyAbsenceModel> tardiness,
      String schoolId) {
    final now = DateTime.now();
    String dateStr;
    try {
      dateStr = DateFormat('EEEE، d MMMM yyyy', 'ar').format(now);
    } catch (_) {
        ...
        background: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
                colors: [Color(0xFF003D33), _kPrimary, _kSecondary, _kAccent],
                      ...
                      Row(children: [
                        ...
                        Expanded(
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                              Text('مركز الحضور والانضباط المدرسي',
                                  style: GoogleFonts.cairo(
                                      color: Colors.white,
                                      fontSize: 14.sp,
                      ...
                      FutureBuilder<int>(
                        ...
                        builder: (context, snap) {
                          ...
                          return Row(children: [
                            _buildKpiChip(
                                'نسبة الحضور',
                                total > 0 ? '${rate.toStringAsFixed(1)}%' : '—',
                                Icons.trending_up_rounded,
                                _kSuccess),
                            SizedBox(width: 8.w),
                            _buildKpiChip('الغائبون', '$absCount',
                                Icons.person_off_rounded, _kDanger),
                            SizedBox(width: 8.w),
                            _buildKpiChip('المتأخرون', '$tardCount',
                                Icons.schedule_rounded, _kWarning),
                            SizedBox(width: 8.w),
                            _buildKpiChip('الإجمالي', '$total',
                                Icons.people_rounded, _kAccent),
                          ]);
                        },
                      ),
                    ]),
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(label,
              style: GoogleFonts.cairo(
                  color: Colors.white.withOpacity(0.82), fontSize: 8.sp),
  ...
  Widget _buildAttendanceRateCard(
      int absCount, int tardCount, String schoolId) {
    return FutureBuilder<int>(
      ...
      builder: (context, snap) {
        ...
        final rate =
            total > 0 ? (present / total * 100).clamp(0, 100).toDouble() : 0.0;
          ...
          child: Row(children: [
                  ...
                  child: Stack(alignment: Alignment.center, children: [
                    CustomPaint(
                      ...
                      painter: _RingPainter(
                          progress: _ringAnimation.value * rate / 100,
                          color: rateColor,
                          backgroundColor: rateColor.withOpacity(0.12)),
                    ),
                    Column(mainAxisSize: MainAxisSize.min, children: [
                      Text(
                          '${(rate * _ringAnimation.value).toStringAsFixed(0)}%',
                          style: GoogleFonts.cairo(
                              fontSize: 22.sp,
                              fontWeight: FontWeight.w800,
                              color: rateColor)),
            ...
            Expanded(
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                  Text('نسبة الحضور الكلية اليوم',
                      style: GoogleFonts.cairo(
                          fontSize: 13.sp,
                          fontWeight: FontWeight.w700,
                          color: _kPrimary)),
                  SizedBox(height: 10.h),
                  _buildRateRow(Icons.check_circle_rounded, 'حاضر', '$present',
                      _kSuccess),
                  SizedBox(height: 4.h),
                  _buildRateRow(
                      Icons.cancel_rounded, 'غائب', '$absCount', _kDanger),
                  SizedBox(height: 4.h),
                  _buildRateRow(Icons.access_time_rounded, 'متأخر',
                      '$tardCount', _kWarning),
                  SizedBox(height: 4.h),
                  _buildRateRow(
                      Icons.people_rounded, 'الإجمالي', '$total', _kPrimary),
                  SizedBox(height: 10.h),
                  Container(
                    padding:
  ...
  Widget _buildRateRow(IconData icon, String label, String value, Color color) {
    return Row(children: [
      ...
      Text(label,
          style:
              GoogleFonts.cairo(fontSize: 11.sp, color: Colors.grey.shade600)),
      const Spacer(),
      Text(value,
          style: GoogleFonts.cairo(
  ...
  Widget _buildQuickStatsRow(int absCount, int tardCount, String schoolId) {
    return FutureBuilder<int>(
      ...
      builder: (context, snap) {
        ...
        return Row(children: [
          _buildStatCard(
              'حاضر', '$present', Icons.how_to_reg_rounded, _kSuccess),
          SizedBox(width: 8.w),
          _buildStatCard(
              'غائب', '$absCount', Icons.person_off_rounded, _kDanger),
          SizedBox(width: 8.w),
          _buildStatCard(
              'متأخر', '$tardCount', Icons.schedule_rounded, _kWarning),
          SizedBox(width: 8.w),
  ...
  Widget _buildSmartInsightsCard(
      List<DailyAbsenceModel> absences, List<DailyAbsenceModel> tardiness) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          Container(
              ...
              child: Icon(Icons.auto_awesome_rounded,
                  color: Colors.amber.shade300, size: 18.sp)),
          SizedBox(width: 10.w),
          Text('توصيات ذكية',
              style: GoogleFonts.cairo(
                  color: Colors.white,
        ...
        _buildInsightItem(
            ...
            absences.isEmpty
                ? 'لا يوجد غياب مسجل اليوم — أداء ممتاز!'
                : 'يوجد ${absences.length} طالب غائب اليوم، يُنصح بالتواصل مع أولياء الأمور.'),
        SizedBox(height: 8.h),
        _buildInsightItem(
            Icons.access_time_filled_rounded,
            Colors.orange.shade300,
            tardiness.isEmpty
                ? 'لا يوجد تأخر مسجل اليوم.'
                : 'تأخر ${tardiness.length} طالب — راجع الطابور الصباحي.'),
        SizedBox(height: 8.h),
        frequentAsync.when(
          data: (analysis) => _buildInsightItem(
              Icons.lightbulb_rounded,
              Colors.cyan.shade300,
              analysis.smartRecommendation.isNotEmpty
                  ? analysis.smartRecommendation
                  : 'استمر في متابعة الحضور اليومي لتحسين الانضباط.'),
          loading: () => _buildInsightItem(Icons.lightbulb_rounded,
              Colors.cyan.shade300, 'جارٍ تحليل البيانات...'),
          error: (_, __) => _buildInsightItem(Icons.lightbulb_rounded,
              Colors.cyan.shade300, 'تعذّر تحميل التوصيات.'),
        ),
      ]),
    );
  }
    ...
    return Row(children: [
      Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10.r)),
          child: Icon(icon, color: _kPrimary, size: 18.sp)),
      SizedBox(width: 10.w),
      Text(title,
          style: GoogleFonts.cairo(
              fontSize: 14.sp, fontWeight: FontWeight.w700, color: _kPrimary)),
      const Spacer(),
      Container(
        padding: EdgeInsets.symmetric(horizontal: 10.w, vertical: 4.h),
        decoration: BoxDecoration(
          ...
          child: Container(
            ...
            child: Column(children: [
              Icon(Icons.check_circle_outline_rounded,
                  color: _kSuccess, size: 48.sp),
              SizedBox(height: 12.h),
              Text('جميع الطلاب حاضرون اليوم',
                  style: GoogleFonts.cairo(
                      fontSize: 14.sp,
                      fontWeight: FontWeight.w700,
                      color: _kSuccess)),
              SizedBox(height: 4.h),
              Text('لا يوجد غياب أو تأخر مسجل',
                  style: GoogleFonts.cairo(
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          ...
          final statusIcon =
              isAbsent ? Icons.person_off_rounded : Icons.access_time_rounded;
              ...
              child: Padding(
                ...
                child: Row(children: [
                  CircleAvatar(
                    ...
                    child: Text(_initials(student.studentName),
                        style: GoogleFonts.cairo(
                            fontSize: 13.sp,
                            fontWeight: FontWeight.w700,
                            color: color)),
        ...
        Row(children: [
          Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10.r)),
              child:
                  Icon(Icons.bar_chart_rounded, color: _kPrimary, size: 18.sp)),
          SizedBox(width: 10.w),
          Text('اتجاه الغياب - آخر 7 أيام',
              style: GoogleFonts.cairo(
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w700,
                  color: _kPrimary)),
  ...
  Widget _buildLegendDot(Color color, String label) {
    return Row(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(label,
          style:
              GoogleFonts.cairo(fontSize: 10.sp, color: Colors.grey.shade600)),
    ]);
  }
}
