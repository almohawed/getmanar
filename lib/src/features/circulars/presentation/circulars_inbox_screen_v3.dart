...
/// صفحة التعاميم V3 - تصميم احترافي مع ألوان جميلة
class CircularsInboxScreenV3 extends ConsumerStatefulWidget {
  const CircularsInboxScreenV3({super.key});

  @override
  ConsumerState<CircularsInboxScreenV3> createState() =>
      _CircularsInboxScreenV3State();
}

class _CircularsInboxScreenV3State
    extends ConsumerState<CircularsInboxScreenV3> {
